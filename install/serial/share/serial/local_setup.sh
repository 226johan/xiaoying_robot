...
: ${AMENT_CURRENT_PREFIX:="/home/johan/slam/xiaoying_robot/install/serial"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/serial/environment/pythonpath.sh"
