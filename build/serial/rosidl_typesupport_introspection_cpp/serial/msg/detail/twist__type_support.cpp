...
{
  new (message_memory) serial::msg::Twist(_init);
}

void Twist_fini_function(void * message_memory)
{
  auto typed_message = static_cast<serial::msg::Twist *>(message_memory);
  typed_message->~Twist();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Twist_message_member_array[1] = {
  {
    ...
    offsetof(serial::msg::Twist, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Twist_message_members = {
  "serial::msg",  // message namespace
  "Twist",  // message name
  1,  // number of fields
  sizeof(serial::msg::Twist),
...
{
  return &::serial::msg::rosidl_typesupport_introspection_cpp::Twist_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serial, msg, Twist)() {
  return &::serial::msg::rosidl_typesupport_introspection_cpp::Twist_message_type_support_handle;
}
