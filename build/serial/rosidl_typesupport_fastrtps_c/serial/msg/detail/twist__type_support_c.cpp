...
#include "serial/msg/detail/twist__rosidl_typesupport_fastrtps_c.h"
...
#include "serial/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Twist__ros_msg_type = serial__msg__Twist;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial
size_t get_serialized_size_serial__msg__Twist(
  const void * untyped_ros_message,
...
static uint32_t _Twist__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_serial__msg__Twist(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial
size_t max_serialized_size_serial__msg__Twist(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = serial__msg__Twist;
    is_plain =
      (
...
static size_t _Twist__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_serial__msg__Twist(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serial, msg, Twist)() {
